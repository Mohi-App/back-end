...
urlpatterns = [
    ...
    path('password_change/dond/', PasswordChangeDoneView.as_view(template_name='authentication/password_change_done.html'),
    ...
    path('reset/<uidb64>/<token>/', PasswordResetConfirmView.as_view(
        ...
        success_url=reverse_lazy('authentication:login')), name='password_reset_confirm'),
